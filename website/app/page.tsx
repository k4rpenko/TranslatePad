      ...
      <div className={styles.notifications}>
        ...
        <div className={styles.notificationThre}>
          <div className={styles.Users}>
            <div className={styles.Peoples}></div>
